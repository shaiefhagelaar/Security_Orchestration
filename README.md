...
Tools: Malware, exploits, and hacking tools used in an attack.
Tradecraft: The hacking methods employed by the adversary, such as taking advantage of commands or living-off-the-land binaries and scripts (LOLBAS). These are well covered by the MITRE ATT&CK matrix.
...
They could adopt the Victim's perspective and look for infrastructure or capability that connects an attacker. 
They could be an infrastructure supplier looking for attackers targeting victims who use their services.
They could even adopt the attacker's perspective and employ Capability and Infrastructure to locate a Victim.
